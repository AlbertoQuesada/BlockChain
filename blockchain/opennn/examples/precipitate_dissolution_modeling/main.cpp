...
//   srand((unsigned)time(NULL));
      ...
      data_set.set_data_file_name("../data/precipitate_dissolution/DataAA-2014-T6.dat");
      ...
      variables_pointer->set_name(0, CharacterString::from_std_string("temperature"));
      variables_pointer->set_name(1, CharacterString::from_std_string("time"));
      variables_pointer->set_name(2, CharacterString::from_std_string("vickers_hardness"));

      variables_pointer->set_units(0, CharacterString::from_std_string("celsius"));
      variables_pointer->set_units(1, CharacterString::from_std_string("s"));
      variables_pointer->set_units(2, CharacterString::from_std_string("none"));
