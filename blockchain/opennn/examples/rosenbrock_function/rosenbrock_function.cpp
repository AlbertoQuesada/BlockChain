...
{
   const size_t variables_number = neural_network_pointer->count_parameters_number();
   ...
   for(unsigned i = 0; i < variables_number-1; i++)
   {
...
double RosenbrockFunction::calculate_performance(const Vector<double>& parameters) const
{
   ...
   for(unsigned i = 0; i < parameters_number-1; i++)
   {
