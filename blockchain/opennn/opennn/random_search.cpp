...
string RandomSearch::RandomSearchResults::object_to_string(void) const
{
   ostringstream buffer;
...
string RandomSearch::write_training_algorithm_type(void) const
{
...
Matrix<string> RandomSearch::to_string_matrix(void) const
{
    ostringstream buffer;
