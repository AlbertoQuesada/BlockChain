...
// Vector< Matrix<double> > calculate_forecasting_target_output_data(void) const method

/// Returns a vector of matrices with number of rows equal to number of testing instances and
/// number of columns equal to two (the targets value and the outputs value).

Vector< Matrix<double> > TestingAnalysis::calculate_forecasting_target_output_data(void) const
{
   // Control sentence (if debug)
...
void TestingAnalysis::print_linear_regression_correlations(void) const
{
...
// Vector< LinearRegressionParameters<double> > calculate_forecasting_linear_regression_parameters(void) const method
...
Vector< LinearRegressionParameters<double> > TestingAnalysis::calculate_forecasting_linear_regression_parameters(void) const
{
   // Control sentence (if debug)
...
// TestingAnalysis::LinearRegressionResults perform_linear_regression_analysis(void) const method
...
// TestingAnalysis::LinearRegressionResults perform_forecasting_linear_regression_analysis(void) const method
...
TestingAnalysis::LinearRegressionResults TestingAnalysis::perform_forecasting_linear_regression_analysis(void) const
{
    check();
    ...
    if(testing_instances_number == 0)
    {
       ...
       buffer << "OpenNN Exception: TestingAnalysis class.\n"
              << "LinearRegressionResults perform_forecasting_linear_regression_analysis(void) const method.\n"
              << "Number of testing instances is zero.\n";
...
// Matrix<double> calculate_forecasting_error_data(void) const method
...
Vector< Matrix<double> > TestingAnalysis::calculate_forecasting_error_data(void) const
{
   // Data set stuff
   ...
   {
      buffer << "OpenNN Exception: TestingAnalysis class.\n"
             << "Vector< Matrix<double> > calculate_forecasting_error_data(void) const.\n"
             << "Unscaling layer is NULL.\n";
...
void TestingAnalysis::print_error_data_statistics(void) const
{
...
// Vector< Vector< Statistics<double> > > calculate_forecasting_error_data_statistics(void) const method
...
Vector< Vector< Statistics<double> > > TestingAnalysis::calculate_forecasting_error_data_statistics(void) const
{
    // Neural network stuff
...
// Vector< Matrix<double> > calculate_forecasting_error_data_statistics_matrices(void) const method
...
Vector< Matrix<double> > TestingAnalysis::calculate_forecasting_error_data_statistics_matrices(void) const
{
...
Matrix<double> TestingAnalysis::calculate_errors(void) const
{
    Matrix<double> errors(4,3,0.0);

    errors.set_column(0, calculate_training_errors());
    errors.set_column(1, calculate_selection_errors());
    errors.set_column(2, calculate_testing_errors());

    return errors;
}


Matrix<double> TestingAnalysis::calculate_binary_classification_errors(void) const
{
...
Matrix<double> TestingAnalysis::calculate_multiple_classification_errors(void) const
{
    Matrix<double> errors(5,3,0.0);
...
Vector<double> TestingAnalysis::calculate_training_errors(void) const
{
    // Data set stuff
    ...
    const size_t training_instances_number = data_set_pointer->get_instances().count_training_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_training_errors(void) const.\n"
...
Vector<double> TestingAnalysis::calculate_binary_classification_training_errors(void) const
{
    // Data set stuff
    ...
    const size_t training_instances_number = data_set_pointer->get_instances().count_training_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_binary_classification_training_errors(void) const.\n"
               << "Number of training instances is zero.\n";
...
Vector<double> TestingAnalysis::calculate_multiple_classification_training_errors(void) const
{
    // Data set stuff
    ...
    const size_t training_instances_number = data_set_pointer->get_instances().count_training_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_multiple_classification_training_errors(void) const.\n"
               << "Number of training instances is zero.\n";
...
Vector<double> TestingAnalysis::calculate_selection_errors(void) const
{
    // Data set stuff
    ...
    const size_t selection_instances_number = data_set_pointer->get_instances().count_selection_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_selection_errors(void) const.\n"
...
Vector<double> TestingAnalysis::calculate_binary_classification_selection_errors(void) const
{
    // Data set stuff
    ...
    const size_t selection_instances_number = data_set_pointer->get_instances().count_selection_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_binary_classification_selection_errors(void) const.\n"
               << "Number of selection instances is zero.\n";
...
Vector<double> TestingAnalysis::calculate_multiple_classification_selection_errors(void) const
{
    // Data set stuff
    ...
    const size_t selection_instances_number = data_set_pointer->get_instances().count_selection_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_multiple_classification_selection_errors(void) const.\n"
               << "Number of selection instances is zero.\n";
...
Vector<double> TestingAnalysis::calculate_testing_errors(void) const
{
    ...
    const size_t testing_instances_number = data_set_pointer->get_instances().count_testing_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector< Matrix<double> > calculate_testing_errors(void) const.\n"
               << "Number of testing instances is zero.\n";
...
// Vector<double> calculate_forecasting_testing_errors(void) const method
...
Vector<double> TestingAnalysis::calculate_forecasting_testing_errors(void) const
{
    // Data set stuff
...
// Vector<double> calculate_binary_classification_testing_errors(void) const method
...
Vector<double> TestingAnalysis::calculate_binary_classification_testing_errors(void) const
{
    // Data set stuff
    ...
    const size_t testing_instances_number = data_set_pointer->get_instances().count_testing_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_binary_classification_testing_errors(void) const.\n"
               << "Number of testing instances is zero.\n";
...
// Vector<double> calculate_multiple_classification_testing_errors(void) const method
...
Vector<double> TestingAnalysis::calculate_multiple_classification_testing_errors(void) const
{
    // Data set stuff
    ...
    const size_t testing_instances_number = data_set_pointer->get_instances().count_testing_instances_number();
     ...
     {
        buffer << "OpenNN Exception: TestingAnalysis class.\n"
               << "Vector<double> calculate_multiple_classification_testing_errors(void) const.\n"
               << "Number of testing instances is zero.\n";
...
//#pragma omp parallel for private(error) reduction(+:sum_squared_error)
    ...
    for(int i = 0; i < (int)testing_instances_number; i++)
    {
        ...
        {
            error = positives_weight*output_data.arrange_row(i).calculate_sum_squared_error(target_data.arrange_row(i));
        }
        else if(target_data(i,0) == 0.0)
        {
            error = negatives_weight*output_data.arrange_row(i).calculate_sum_squared_error(target_data.arrange_row(i));
        }
        else
        {
            ostringstream buffer;
...
//    const size_t negatives = data_set_pointer->calculate_training_negatives(targets_indices[0]);
    ...
    const size_t negatives = target_data.arrange_column(0).count_equal_to(0.0);
...
Matrix<size_t> TestingAnalysis::calculate_confusion(void) const
{
   ...
   {      
       ...
       buffer << "OpenNN Exception: TestingAnalysis class." << endl
              << "Matrix<size_t> calculate_confusion(void) const method." << endl
...
TestingAnalysis::RocAnalysisResults TestingAnalysis::perform_roc_analysis (void) const
{
    ...
    if(inputs_number != variables.count_inputs_number())
    {
        ...
        buffer << "OpenNN Exception: TestingAnalysis class." << endl
               << "RocCurveResults perform_roc_analysis(void) const method." << endl
               << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Matrix<double> TestingAnalysis::perform_cumulative_gain_analysis(void) const
{
    ...
    if(inputs_number != variables.count_inputs_number())
    {
        ...
        buffer << "OpenNN Exception: TestingAnalysis class." << endl
               << "Matrix<double> perform_cumulative_gain_analysis(void) const method." << endl
               << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Matrix<double> TestingAnalysis::perform_lift_chart_analysis(void) const
{
    ...
    if(inputs_number != variables.count_inputs_number())
    {
        ...
        buffer << "OpenNN Exception: TestingAnalysis class." << endl
               << "Matrix<double> perform_lift_chart_analysis(void) const method." << endl
               << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
TestingAnalysis::KolmogorovSmirnovResults TestingAnalysis::perform_Kolmogorov_Smirnov_analysis(void) const
{
    ...
    if(inputs_number != variables.count_inputs_number())
    {
        ...
        buffer << "OpenNN Exception: TestingAnalysis class." << endl
               << "Matrix<double> perform_Kolmogorov_Smirnov_analysis(void) const method." << endl
               << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Matrix<double> TestingAnalysis::perform_calibration_plot_analysis(void) const
{
    ...
    if(inputs_number != variables.count_inputs_number())
    {
        ...
        buffer << "OpenNN Exception: TestingAnalysis class." << endl
               << "Matrix<double> perform_calibration_plot_analysis(void) const method." << endl
               << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
TestingAnalysis::BinaryClassifcationRates TestingAnalysis::calculate_binary_classification_rates(void) const
{
    ...
    if(inputs_number != variables.count_inputs_number())
    {
        ...
        buffer << "OpenNN Exception: TestingAnalysis class." << endl
               << "BinaryClassificationRates calculate_binary_classification_rates(void) const method." << endl
               << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Vector< Vector<double> > TestingAnalysis::calculate_error_autocorrelation(const size_t& maximum_lags_number) const
{
    ...
    buffer << "OpenNN Exception: TestingAnalysis class." << endl
           << "Vector<double> calculate_error_autocorrelation(void) const method." << endl
           << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Vector< Vector<double> > TestingAnalysis::calculate_forecasting_error_autocorrelation(const size_t& maximum_lags_number) const
{
    ...
    buffer << "OpenNN Exception: TestingAnalysis class.\n"
          << "Vector<double> calculate_forecasting_error_autocorrelation(void) const method.\n"
          << "Pointer to multilayer perceptron in neural network is NULL.\n";
    ...
    buffer << "OpenNN Exception: TestingAnalysis class." << endl
           << "Vector<double> calculate_forecasting_error_autocorrelation(void) const method." << endl
           << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Vector< Vector<double> > TestingAnalysis::calculate_input_error_cross_correlation(const size_t& maximum_lags_number) const
{
    ...
    buffer << "OpenNN Exception: TestingAnalysis class." << endl
           << "Vector<double> calculate_input_error_cross_correlation(void) const method." << endl
           << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Vector< Vector<double> > TestingAnalysis::calculate_forecasting_input_error_cross_correlation(const size_t& maximum_lags_number) const
{
    ...
    buffer << "OpenNN Exception: TestingAnalysis class.\n"
          << "Vector<double> calculate_forecasting_input_error_cross_correlation(void) const method.\n"
          << "Pointer to multilayer perceptron in neural network is NULL.\n";
    ...
    buffer << "OpenNN Exception: TestingAnalysis class." << endl
           << "Vector<double> calculate_forecasting_input_error_cross_correlation(void) const method." << endl
           << "Number of inputs in neural network must be equal to number of inputs in data set." << endl;
...
Vector< Vector<double> > TestingAnalysis::calculate_forecasting_time_series(void) const
{
/*
    #ifdef __OPENNN_DEBUG__
...
Vector<double> TestingAnalysis::calculate_binary_classification_tests(void) const
{
   ...
   if(!data_set_pointer)
   {
      ...
      buffer << "OpenNN Exception: TestingAnalysis class." << endl
             << "Vector<double> calculate_binary_classification_tests(void) const." << endl
...
// string object_to_string(void) const method

/// Returns a string representation of the testing analysis object. 

string TestingAnalysis::object_to_string(void) const
{
   ostringstream buffer;
