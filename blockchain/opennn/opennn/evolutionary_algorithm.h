...
public:
   ...
   string write_fitness_assignment_method(void) const;

   const SelectionMethod& get_selection_method(void) const;
   string write_selection_method(void) const;

   const RecombinationMethod& get_recombination_method(void) const;
   string write_recombination_method(void) const;

   const MutationMethod& get_mutation_method(void) const;
   string write_mutation_method(void) const;
   ...
   string write_training_algorithm_type(void) const;

   // Serialization methods

   Matrix<string> to_string_matrix(void) const;
