...
Vector<string> Instances::write_uses(void) const
{
   const size_t instances_number = get_instances_number();
...
// Vector<string> write_abbreviated_uses(void) const method

/// Returns the use of every instance (training, selection, testing) in a string vector.

Vector<string> Instances::write_abbreviated_uses(void) const
{
   const size_t instances_number = get_instances_number();
...
void Instances::set_unused(void)
{
    const size_t instances_number = get_instances_number();
...
void Instances::selection_to_testing(void)
{
    const size_t instances_number = get_instances_number();
...
void Instances::testing_to_selection(void)
{
    const size_t instances_number = get_instances_number();
...
string Instances::object_to_string(void) const
{
   ostringstream buffer;
