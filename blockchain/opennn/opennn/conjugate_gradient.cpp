...
// string write_training_direction_method(void) const method

/// Returns a string with the name of the training direction.  

string ConjugateGradient::write_training_direction_method(void) const
{
...
const bool& ConjugateGradient::get_apply_early_stopping(void) const
{
...
string ConjugateGradient::ConjugateGradientResults::object_to_string(void) const
{
   ostringstream buffer;
...
Matrix<string> ConjugateGradient::ConjugateGradientResults::write_final_results(const size_t& precision) const
{
   ostringstream buffer;
   ...
   for(size_t iteration = 0; iteration <= maximum_iterations_number; iteration++)
   {
      ...
      else if(iteration != 0 && loss_increase <= minimum_loss_increase)
      {
         if(display)
         {
            ...
            cout << "Performance increase: " << loss_increase << endl;
         }
...
string ConjugateGradient::write_training_algorithm_type(void) const
{
...
Matrix<string> ConjugateGradient::to_string_matrix(void) const
{
    ostringstream buffer;
