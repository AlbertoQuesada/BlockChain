...
// Vector<string> write_scaling_methods(void) const method

/// Returns a vector of strings with the name of the method used for each scaling neuron.

Vector<string> ScalingLayer::write_scaling_methods(void) const
{
    const size_t scaling_neurons_number = get_scaling_neurons_number();
...
// string write_scaling_methods_text(void) const method

/// Returns a vector of strings with the name of the methods used for scaling,
/// as paragaph text.

Vector<string> ScalingLayer::write_scaling_methods_text(void) const
{
    const size_t scaling_neurons_number = get_scaling_neurons_number();
    ...
    for(size_t i = 0; i < scaling_neurons_number; i++)
    {
        ...
        else
        {
            ...
            buffer << "OpenNN Exception: ScalingLayer class.\n"
                   << "Vector<string> write_scaling_methods_text(void) const method.\n"
                   << "Unknown " << i << " scaling method.\n";
...
string ScalingLayer::object_to_string(void) const
{
    ostringstream buffer;
