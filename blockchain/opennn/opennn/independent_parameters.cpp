...
// const Vector<string>& get_names(void) const method
...
const Vector<string>& IndependentParameters::get_names(void) const
{
   return(names);    
}
...
// const Vector<string>& get_units(void) const method
...
const Vector<string>& IndependentParameters::get_units(void) const
{
   return(units);
}
...
// const Vector<string>& get_descriptions(void) const method
...
const Vector<string>& IndependentParameters::get_descriptions(void) const
{
   return(descriptions);
}
...
// Vector< Vector<string> > arrange_information(void) method
...
Vector< Vector<string> > IndependentParameters::arrange_information(void) 
{
...
// string write_scaling_method(void) const method

/// Returns a string with the method used for scaling and unscaling the independent parameters.

string IndependentParameters::write_scaling_method(void) const
{
...
// string write_bounding_method(void) const method

/// Returns a string with the method used for bounding the independent parameters.

string IndependentParameters::write_bounding_method(void) const
{
...
string IndependentParameters::object_to_string(void) const
{
   ostringstream buffer;
