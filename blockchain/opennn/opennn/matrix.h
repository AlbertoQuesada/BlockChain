...
/*                                                                                                              */
/*   Roberto Lopez                                                                                              */
/*   Artelnics f- Making intelligent use of data                                                                */
...
public:
    ...
    size_t count_not_equal_to(const size_t&, const T&, const bool&) const;
    size_t count_not_equal_to(const size_t&, const Vector<T>&, const bool&) const;

    size_t count_not_equal_to(const size_t&, const T&, const size_t&, const T&, const bool&) const;

    size_t count_not_equal_to(const string&, const T&, const bool&) const;
    size_t count_not_equal_to(const string&, const T&, const string&, const T&, const bool&) const;
    ...
    Vector<T> arrange_rows(const size_t&, const size_t&) const;

    Vector<T> arrange_row(const size_t&, const Vector<size_t>&) const;

    Vector<T> arrange_column(const size_t&) const;
    Vector<T> arrange_column(const string&) const;

    Matrix<T> arrange_columns(const Vector<string>&) const;

    Vector<T> arrange_column(const size_t&, const Vector<size_t>&) const;

    Matrix<T> arrange_columns_contain(const string&) const;

    Matrix<T> arrange_column_equal_to(const size_t&, const T&, const bool&) const;
    Matrix<T> arrange_column_equal_to(const string&, const T&, const bool&) const;

    Matrix<T> arrange_column_equal_to(const size_t&, const Vector<T>&, const bool&) const;
    Matrix<T> arrange_column_equal_to(const string&, const Vector<T>&, const bool&) const;

    Matrix<T> arrange_column_equal_to(const size_t&, const Vector<T>&,
                                      const size_t&, const T&, const bool&) const;

    Matrix<T> arrange_column_equal_to(const string&, const Vector<T>&,
                                      const string&, const T&, const bool&) const;

    Matrix<T> arrange_column_equal_to(const size_t&, const T&,
                                      const size_t&, const T&,
                                      const size_t&, const T&,
                                      const size_t&, const T&, const bool&) const;

    Matrix<T> arrange_column_equal_to(const string&, const T&,
    ...
    Matrix<T> arrange_column_not_equal_to(const size_t&, const T&, const bool&) const;
    Matrix<T> arrange_column_not_equal_to(const string&, const T&, const bool&) const;

    Matrix<T> arrange_column_not_equal_to(const string&, const Vector<T>&, const bool&) const;
    Matrix<T> arrange_column_not_equal_to(const size_t&, const Vector<T>&, const bool&) const;

    Matrix<T> arrange_column_less_than(const size_t&, const T&) const;
    Matrix<T> arrange_column_less_than(const string&, const T&, const bool&) const;

    Matrix<T> arrange_column_greater_than(const size_t&, const T&, const bool&) const;
    Matrix<T> arrange_column_greater_than(const string&, const T&, const bool&) const;

    Matrix<T> arrange_by_minimum_maximum(const size_t&, const T&, const T&) const;

    size_t count_dates(const string&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const bool&) const;
    size_t count_dates(const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const bool&) const;

    Matrix<T> filter_dates(const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const bool&) const;
    Matrix<T> filter_dates(const string&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const size_t&, const bool&) const;
    ...
    Matrix<T> arrange_unique_rows(void) const;
    Matrix<T> arrange_unique_rows_frequency(void) const;

    size_t count_unique(const string&, const T&, const string&, const bool&) const;

    Vector<size_t> count_unique_elements(void) const;
    ...
    void set_column(const string&, const Vector<T>&);
    ...
    void insert_column(const string&, const Vector<T>&);
    ...
    Matrix<T> remove_row(const size_t&) const;
    void remove_rows(const Vector<size_t>&);

    Matrix<T> remove_rows_with_value(const T&);

    Matrix<T> remove_first_rows(const size_t&) const;
    Matrix<T> arrange_first_rows(const size_t&) const;

    Matrix<T> remove_last_rows(const size_t&) const;
    Matrix<T> arrange_last_rows(const size_t&) const;

    void remove_column(const size_t&);
    void remove_columns(const Vector<size_t>&);

    void remove_column(const string&);
    void remove_columns(const Vector<string>&);

    void remove_constant_rows(const bool&);
    void remove_constant_columns(const bool&);
    ...
    void replace_special_characters(void);

    void replace_column_equal_to(const string&, const T&, const T&, const bool&);
    void replace_column_not_equal_to(const string&, const T&, const T&, const bool&);
    void replace_column_not_equal_to(const string&, const Vector<T>&, const T&, const bool&);

    void replace_column_contains(const string&, const string&, const string&, const bool&);
    size_t count_column_contains(const string&, const string&, const bool&) const;

    bool has_column_value(const size_t&, const T&, const bool&) const;
    ...
    Vector<int> calculate_rows_sum_int(void) const;
    Vector<T> calculate_rows_sum(void) const;
    Vector<T> calculate_columns_sum(void) const;
    ...
    Vector<double> calculate_mean_monthly_occurrences(void) const;
    ...
    Vector<double> calculate_median(void) const;
    ...
    Vector< double > calculate_missing_values_percentage(void) const;
    ...
    Vector<T> calculate_means_integers(void) const;
    ...
    Vector<T> calculate_means_binary(void) const;
    Vector<T> calculate_means_binary_column(void) const;
    Vector<T> calculate_means_binary_columns(void) const;
    ...
    Vector< Statistics<T> > scale_logarithmic(void);
    ...
    void convert_time_column_dd_mm_dd_yyyy_hh(const string&, const char&, const bool&);

    void convert_time_column_yyyy_mm(const string&, const char&, const bool&);

    void convert_time_column_dd_mm_yyyy(const string&, const char&, const bool&);
    void convert_time_column_mm_dd_yyyy(const string&, const char&, const bool&);
    ...
    void load_strings(const string&, const char& = ',');
    ...
    void save_csv(const string&, const char& separator = ',',  const Vector<string>& = Vector<string>(),  const Vector<string>& = Vector<string>(), const string& = "Id") const;
    ...
    Matrix<size_t> to_size_t_matrix(void) const;
    Matrix<double> to_double_matrix(void) const;
    Matrix<string> to_string_matrix(const size_t& = 3) const;
    SparseMatrix<T> to_sparse_matrix(void) const;

    Matrix<size_t> string_to_size_t(void) const;
    Matrix<double> string_to_double(void) const;
    ...
    Vector< Vector<T> > to_vector_of_vectors(void) const;
...
template <class T>
size_t Matrix<T>::get_empty_row_index(void) const
{
...
template <class T>
size_t Matrix<T>::count_not_equal_to(const size_t& column_index, const T& value, const bool& header) const
{
    size_t count = 0;

    const size_t start = header ? 1 : 0;

    for(size_t i = start; i < rows_number; i++)
    {
        if((*this)(i, column_index) != value)
        {
            count++;
...
template <class T>
size_t Matrix<T>::count_not_equal_to(const size_t& column_index, const Vector<T>& values, const bool& header) const
{
    const size_t values_size = values.size();
...
size_t Matrix<T>::count_not_equal_to(const size_t& column_1_index, const T& value_1,
                                     const size_t& column_2_index, const T& value_2, const bool& header) const
{
    size_t count = 0;
...
template <class T>
size_t Matrix<T>::count_not_equal_to(const string& column_name, const T& value, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(count_not_equal_to(column_index, value, header));
}


template <class T>
size_t Matrix<T>::count_not_equal_to(const string& column_1_name, const T& value_1,
                                     const string& column_2_name, const T& value_2, const bool& header) const
{
    const size_t column_1_index = get_column_index(column_1_name);
    const size_t column_2_index = get_column_index(column_2_name);

    return(count_not_equal_to(column_1_index, value_1, column_2_index, value_2, header));
}
...
template <class T>
Vector<T> Matrix<T>::arrange_rows(const size_t& first_index, const size_t& last_index) const
{
    #ifdef __OPENNN_DEBUG__
    ...
    if(last_index > rows_number)
    {
       ...
       buffer << "OpenNN Exception: Matrix Template.\n"
              << "Vector<T> arrange_rows(const size_t&, const size_t&) const method.\n"
    ...
    {
        new_row = new_row.assemble(arrange_row(i));
    }
...
template <class T>
Vector<T> Matrix<T>::arrange_column(const string& column_name) const
{
   // Control sentence (if debug)
   ...
   if(this->empty())
   {
      ...
      buffer << "OpenNN Exception: Matrix Template.\n"
             << "Vector<T> arrange_column(const string&) const method.\n"
             << "Matrix is empty.\n";
   ...
   return(arrange_column(column_index));
}


template <class T>
Matrix<T> Matrix<T>::arrange_columns(const Vector<string>& column_names) const
{
    const size_t columns_number = column_names.size();

    Vector<size_t> indices(columns_number);

    for(size_t i = 0; i < columns_number; i++)
    {
        indices[i] = get_column_index(column_names[i]);
    }

   return(arrange_submatrix_columns(indices));
}
...
template <class T>
Matrix<T> Matrix<T>::arrange_columns_contain(const string& find_what) const
{
...
template <class T>
Matrix<T> Matrix<T>::arrange_unique_rows(void) const
{
    Matrix<string> unique(1,columns_number);

    unique.insert_row(0, arrange_row(0));

    #pragma omp parallel for

    for(int i = 1; i < rows_number; i++)
    {
        const Vector<string> row = (*this).arrange_row(i);
        ...
        {
            unique_row = unique.arrange_row(j);
...
template <class T>
Matrix<T> Matrix<T>::arrange_unique_rows_frequency(void) const
{
    Matrix<string> unique(1,columns_number);

    Vector<string> row;

    unique.set_row(0,(*this).arrange_row(0));
    ...
    unique.insert_column(0,frequency);
...
template <class T>
size_t Matrix<T>::count_unique(const string& column_1_name, const T& value_1, const string& column_2_name, const bool& header) const
{
    ...
    return(elements.arrange_unique().size());
}

template <class T>
Vector<size_t> Matrix<T>::count_unique_elements(void) const
{
    Vector<size_t> unique_elements;

    for(size_t i = 0; i < columns_number; i++)
    {
        unique_elements.push_back((*this).arrange_column(i).arrange_unique().size() - 1);
    }
...
template <class T>
void Matrix<T>::set_column(const string& column_name, const Vector<T>& new_column)
{
    const size_t column_index = get_column_index(column_name);
...
void Matrix<T>::append_column(const Vector<T>& new_column)
{
   ...
   if(rows_number == 0)
   {
       const size_t new_column_size = new_column.size();

       set(new_column_size, columns_number+1);
   }
   else
   {
...
template <class T>
void Matrix<T>::insert_column(const string& column_name, const Vector<T>& new_column)
{
    const size_t column_index = get_column_index(column_name);

    insert_column(column_index, new_column);
}
...
void Matrix<T>::split_column(const string& column_name, const Vector<string>& new_columns_name, const char& delimiter, const string& missing_value_label)
{
    ...
    new_row = arrange_row(0).replace_element(column_index, new_columns_name);
    ...
    for(size_t i = 1; i < rows_number; i++)
    {
        ...
        {
            new_row = arrange_row(i).replace_element(column_index, missing_values_vector);
        }
        else
        {
            new_row = arrange_row(i).split_element(column_index, delimiter);
        }
...
void Matrix<T>::split_column(const string& column_name, const string& column_1_name, const string& column_2_name, const size_t& size_1, const size_t& size_2)
{
    ...
    set_column(column_index, column_1);
    insert_column(column_index+1, column_2);
}
...
void Matrix<T>::merge_columns(const string& column_1_name, const string& column_2_name, const string& joined_column_name, const char& separator)
{
    ...
    const Vector<T> column_1 = arrange_column(column_1_index);
    const Vector<T> column_2 = arrange_column(column_2_index);

    Vector<T> joined_column (column_1.size());

    for(size_t i=1; i<column_1.size(); i++)
    {
        joined_column[i] = column_1[i] + separator + column_2[i];
    }

    joined_column[0] = joined_column_name;

    remove_column(column_2_index);
...
void Matrix<T>::merge_columns(const size_t& column_1_index, const size_t& column_2_index, const char& separator)
{
    ...
    const Matrix<T> columns_matrix = arrange_submatrix_columns(indices);
    ...
    for (size_t i = 0; i < rows_number; i++)
    {
        ...
        {
            const Vector<T> column = columns_matrix.arrange_column(j);
                                    ...
                                    const string& right_header_tag, const string& left_header_tag) const
{
    ...
    const Vector<T> columns_1 = this->arrange_column(columns_1_index);
    const Vector<T> columns_2 = other_matrix.arrange_column(columns_2_index);

    const size_t columns_1_size = columns_1.size();

    const Vector<T> header_1 = this->arrange_row(0);
    const Vector<T> header_2 = other_matrix.arrange_row(0);

    size_t merged_rows_number = 1;

    for(size_t i = 1; i < columns_1_size; i++)
    {
    ...
    Vector<T> merged_header = header_1.remove_element(columns_1_index) + right_header_tag;

    merged_header = merged_header.assemble(header_2.remove_element(columns_2_index) + left_header_tag);
    ...
    merged_matrix.set_row(0, merged_header);
    ...
    for(size_t i = 1; i < columns_1_size; i++)
    {
        ...
        const Vector<size_t> columns_2_equal_indices = columns_2.arrange_equal_to_indices(current_index_value);

        const size_t columns_2_equal_indices_size = columns_2_equal_indices.size();

        for(size_t j = 0; j < columns_2_equal_indices_size; j++)
        {
            Vector<T> current_row = this->arrange_row(i);

            current_row = current_row.assemble(other_matrix.arrange_row(columns_2_equal_indices[j]).remove_element(columns_2_index));
...
{
//    const Vector<T> this_ids = this->arrange_column(this_column_index);
//    const Vector<T> other_ids = other.arrange_column(other_column_index);

//    const Vector<T> unique = this_ids.assemble(other_ids).arrange_unique();
...
template <class T>
Matrix<T> Matrix<T>::remove_row(const size_t& row_index) const
{
   #ifdef __OPENNN_DEBUG__
...
template <class T>
void Matrix<T>::remove_rows(const Vector<size_t>& rows_to_remove)
{
    ...
    *this = arrange_submatrix_rows(rows_to_keep);
}


template <class T>
Matrix<T> Matrix<T>::remove_rows_with_value(const T& value)
{
    Vector<T> row(columns_number);
    ...
    return(arrange_submatrix_rows(indices));
}


template <class T>
Matrix<T> Matrix<T>::remove_first_rows(const size_t& number) const
{
...
template <class T>
Matrix<T> Matrix<T>::arrange_first_rows(const size_t& number) const
{
...
template <class T>
Matrix<T> Matrix<T>::remove_last_rows(const size_t& number) const
{
    const size_t rows_number = get_rows_number();
...
template <class T>
Matrix<T> Matrix<T>::arrange_last_rows(const size_t& number) const
{
    const size_t rows_number = get_rows_number();
...
// void remove_column(const size_t&) method
...
template <class T>
void Matrix<T>::remove_column(const size_t& column_index)
{
   #ifdef __OPENNN_DEBUG__
   ...
   if(column_index >= columns_number)
   {
      ...
      buffer << "OpenNN Exception: Matrix Template.\n"
             << "remove_column(const size_t&) const.\n"
...
template <class T>
void Matrix<T>::remove_column(const string& column_name)
{
    const Vector<T> names = arrange_row(0);

    const Vector<size_t> indices = names.arrange_equal_to_indices(column_name);
    ...
    else
    {
        ...
        buffer << "OpenNN Exception: Matrix Template.\n"
               << "void Matrix<T>::remove_column_by_name(const string& column_name).\n"
...
template <class T>
void Matrix<T>::remove_columns(const Vector<size_t>& remove_indices)
{
    ...
    {
        const Matrix<T> new_data = arrange_submatrix_columns(keep_indices);
...
template <class T>
void Matrix<T>::remove_columns(const Vector<string>& remove_names)
{
    const Vector<T> names = arrange_row(0);

    const Vector<size_t> indices = names.arrange_not_equal_to_indices(remove_names);

    const size_t indices_size = indices.size();

    if(indices_size == columns_number)
    {
        return;
    }
    else
    {
        const Matrix<T> new_data = arrange_submatrix_columns(indices);
...
template <class T>
void Matrix<T>::remove_constant_columns(const bool& header)
{
    ...
    for(size_t i = 0; i < columns_number; i++)
    {
        ...
        if(header)
        {
            column = column.remove_element(0);
        }

        if(column.is_constant_string())
        {
            constant_columns.push_back(i);
        }
    }

    remove_columns(constant_columns);
}


template <class T>
void Matrix<T>::remove_constant_rows(const bool& header)
{
...
Matrix<T> Matrix<T>::sort_ascending(const size_t& column_index) const
{
    ...
    const Vector<size_t> indices = column.sort_ascending();
...
Matrix<T> Matrix<T>::sort_ascending_strings(const size_t& column_index) const
{
    ...
    const Vector<double> column = arrange_column(column_index).string_to_double();
...
Matrix<T> Matrix<T>::sort_descending_strings(const size_t& column_index) const
{
    ...
    const Vector<size_t> indices = column.sort_descending();
...
Matrix<T> Matrix<T>::sort_ascending_strings_absolute_value(const size_t& column_index) const
{
    ...
    const Vector<double> column = arrange_column(column_index).string_to_double().calculate_absolute_value();
...
template <class T>
void Matrix<T>::replace_column_equal_to(const string& column_name, const T& find_value, const T& replace_value, const bool& header)
{
    const size_t column_index = get_column_index(column_name);
...
template <class T>
void Matrix<T>::replace_column_not_equal_to(const string& column_name, const T& find_value, const T& replace_value, const bool& header)
{
    const size_t column_index = get_column_index(column_name);
...
template <class T>
void Matrix<T>::replace_column_not_equal_to(const string& column_name, const Vector<T>& find_values, const T& replace_value, const bool& header)
{
    const size_t column_index = get_column_index(column_name);
...
template <class T>
void Matrix<T>::replace_column_contains(const string& column_name, const string& find_what, const string& replace_with, const bool& header)
{
    const size_t column_index = get_column_index(column_name);
...
template <class T>
size_t Matrix<T>::count_column_contains(const string& column_name, const string& find_what, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);
...
template <class T>
bool Matrix<T>::has_column_value(const size_t& column_index, const T& value, const bool& header) const
{
    const size_t start = header ? 1 : 0;
...
template <class T>
Vector<int> Matrix<T>::calculate_rows_sum_int(void) const
{
    // Control sentence (if debug)
...
template <class T>
Vector<T> Matrix<T>::calculate_columns_sum(void) const
{
    // Control sentence (if debug)
    ...
    if(this->empty())
    {
       ...
       cout << "OpenNN Exception: Matrix Template.\n"
                 << "Vector<T> calculate_columns_sum(void) const method.\n"
                 << "Matrix is empty.\n";
...
template <class T>
Vector<double> Matrix<T>::calculate_mean_monthly_occurrences(void) const
{
    Vector<double> row;
    ...
    for(size_t i = 0; i < rows_number; i++)
    {
        row = (*this).arrange_row(i);

        row = row.remove_element(0);

        row = row.arrange_not_equal_to(0);
...
template <class T>
Vector<double> Matrix<T>::calculate_median(void) const
{
   // Control sentence (if debug)
   ...
   if(rows_number == 0)
   {
      ...
      buffer << "OpenNN Exception: Matrix template.\n"
             << "Vector<double> calculate_median(void) const method.\n"
             << "Number of rows must be greater than one.\n";
   ...
   for(size_t j = 0; j < columns_number; j++)
   {
       Vector<T> sorted_column(this->arrange_column(j));
...
double Matrix<T>::calculate_median(const size_t& column_index) const
{
   ...
   Vector<T> sorted_column(this->arrange_column(column_index));
...
Vector<double> Matrix<T>::calculate_median(const Vector<size_t>& row_indices, const Vector<size_t>& column_indices) const
{
   ...
   for(size_t j = 0; j < column_indices_size; j++)
   {
      ...
      Vector<T> sorted_column(this->arrange_column(column_index, row_indices));
                                                          ...
                                                          const Vector< Vector<size_t> >& missing_indices) const
{
   ...
   for(int j = 0; j < (int)column_indices_size; j++)
   {
      ...
      Vector<T> sorted_column(this->arrange_column(column_index, used_rows[j]));
...
template <class T>
Vector< double > Matrix<T>::calculate_missing_values_percentage(void) const
{
...
template <class T>
Vector<T> Matrix<T>::calculate_means_integers(void) const
{
#ifdef __OPENNN_DEBUG__
...
if(columns_number != 2)
{
   ...
   throw logic_error(buffer.str());
    ...
    const Vector<size_t> integers = this->arrange_column(0).arrange_integers(get_rows_number());
...
template <class T>
Vector<T> Matrix<T>::calculate_means_binary(void) const
{
    if(columns_number == 2)
    {
...
template <class T>
Vector<T> Matrix<T>::calculate_means_binary_column(void) const
{
...
template <class T>
Vector<T> Matrix<T>::calculate_means_binary_columns(void) const
{
...
Vector<T> Matrix<T>::calculate_means_continiuous(const size_t& bins_number) const
{
    ...
    const T minimum = this->arrange_column(0).calculate_minimum();
    const T maximum = this->arrange_column(1).calculate_maximum();
...
Vector<T> Matrix<T>::calculate_rows_means(const Vector<size_t>& row_indices) const
{
    ...
    for(size_t i = 0; i < columns_number; i++)
    {
        column = arrange_column(i, used_row_indices);
...
if(columns_number == rows_indices.size())
{
   ...
   buffer << "OpenNN Exception: Matrix template."
          << "void calculate_box_plots(void) const method.\n"
   ...
   throw logic_error(buffer.str());
    ...
    for(int i = 0; i < (int)columns_number; i++)
    {
        ...
        column = this->arrange_column(columns_indices[i]).arrange_subvector(rows_indices[i]);
...
template <class T>
Vector< Statistics<T> > Matrix<T>::scale_logarithmic(void)
{
    const Vector< Statistics<T> > statistics = calculate_statistics();
...
template <class T>
Matrix<T> Matrix<T>::arrange_by_minimum_maximum(const size_t& column_index, const T& minimum, const T& maximum) const
{
    const Vector<T> column = arrange_column(column_index);
...
size_t Matrix<T>::count_dates(const size_t& column_index,
                              ...
                              const size_t& end_day, const size_t& end_month, const size_t& end_year, const bool& header) const
{
    size_t count = 0;
    ...
    start_tm.tm_mday = (int)start_day;
    start_tm.tm_mon = (int)start_month - 1;
    start_tm.tm_year = (int)start_year - 1900;

    const time_t start_date = mktime(&start_tm) + 3600*24;

    struct tm end_tm = {0};
    end_tm.tm_mday = (int)end_day;
    end_tm.tm_mon = (int)end_month - 1;
    end_tm.tm_year = (int)end_year - 1900;

    const time_t end_date = mktime(&end_tm) + 3600*24;
                              ...
                              const size_t& end_day, const size_t& end_month, const size_t& end_year, const bool& header) const
{
    ...
    return count_dates(column_index, start_day, start_month, start_year, end_day, end_month, end_year, header);
}
...
Matrix<T> Matrix<T>::filter_dates(const size_t& column_index,
                                  ...
                                  const size_t& end_day, const size_t& end_month, const size_t& end_year, const bool& header) const
{
    const size_t count = count_dates(column_index, start_day, start_month, start_year, end_day, end_month, end_year, header);

    const size_t new_rows_number = header ? count+1 : count;
...
Matrix<T> Matrix<T>::fill_missing_dates_dd_mm_yyyy(const string& column_name, const char& separator) const
{
    ...
    Matrix<T> data(*this);
    data.convert_time_column_dd_mm_yyyy(column_name, separator, true);
...
//    const size_t start = 1;
    ...
    new_data.set_row(0, arrange_row(0));
                                  ...
                                  const size_t& end_day, const size_t& end_month, const size_t& end_year, const bool& header) const
{
    ...
    return filter_dates(column_index, start_day, start_month, start_year, end_day, end_month, end_year, header);
}
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const size_t& column_index, const T& value, const bool& header) const
{
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const size_t& column_1, const T& value_1,
                                             const size_t& column_2, const T& value_2,
                                             const size_t& column_3, const T& value_3,
                                             const size_t& column_4, const T& value_4, const bool& header) const
{
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const string& column_1_name, const T& value_1,
                                             const string& column_2_name, const T& value_2,
                                             const string& column_3_name, const T& value_3,
                                             const string& column_4_name, const T& value_4,
                                             const bool& header) const
{
    ...
    return(arrange_column_equal_to(column_1_index, value_1, column_2_index, value_2, column_3_index, value_3, column_4_index, value_4, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const size_t& column_index, const Vector<T>& values, const bool& header) const
{
    const size_t values_size = values.size();
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_not_equal_to(const size_t& column_index, const Vector<T>& values, const bool& header) const
{
    const size_t values_size = values.size();

    size_t new_rows_number = rows_number - count_not_equal_to(column_index, values, header);
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const size_t& index_1, const Vector<T>& values_1,
                                             const size_t& index_2, const T& value_2, const bool& header) const
{    
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const size_t& column_1_index, const Vector<T>& values_1,
                                             const size_t& column_2_index, const T& value_2,
                                             const size_t& column_3_index, const T& value_3,
                                             const size_t& column_4_index, const T& value_4, const bool& header) const
{
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const string& column_1, const Vector<T>& values_1,
                                             const string& column_2, const T& value_2,
                                             const string& column_3, const T& value_3,
                                             const string& column_4, const T& value_4, const bool& header) const
{
    ...
    return(arrange_column_equal_to(column_1_index, values_1, column_2_index, value_2, column_3_index, value_3, column_4_index, value_4, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const string& column_name, const T& value, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(arrange_column_equal_to(column_index, value, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const string& column_name, const Vector<T>& values, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(arrange_column_equal_to(column_index, values, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_not_equal_to(const string& column_name, const Vector<T>& values, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(arrange_column_not_equal_to(column_index, values, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_equal_to(const string& name_1, const Vector<T>& values_1,
                                             const string& name_2, const T& value_2, const bool& header) const
{
    const size_t index_1 = get_column_index(name_1);
    const size_t index_2 = get_column_index(name_2);

    return(arrange_column_equal_to(index_1, values_1, index_2, value_2, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_not_equal_to(const size_t& column_index, const T& value, const bool& header) const
{
    const Vector<T> column = arrange_column(column_index);

    size_t new_rows_number = rows_number - column.count_equal_to(value);
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_not_equal_to(const string& column_name, const T& value, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(arrange_column_not_equal_to(column_index, value, header));
}


template <class T>
Matrix<T> Matrix<T>::arrange_column_less_than(const size_t& column_index, const T& value) const
{
    const Vector<T> column = arrange_column(column_index);
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_less_than(const string& column_name, const T& value, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(arrange_column_less_than(column_index, value, header));
}



template <class T>
Matrix<T> Matrix<T>::arrange_column_greater_than(const size_t& column_index, const T& value, const bool& header) const
{
    const Vector<T> column = arrange_column(column_index);

    size_t new_rows_number = column.count_greater_than(value);
...
template <class T>
Matrix<T> Matrix<T>::arrange_column_greater_than(const string& column_name, const T& value, const bool& header) const
{
    const size_t column_index = get_column_index(column_name);

    return(arrange_column_greater_than(column_index, value, header));
}


template <class T>
void Matrix<T>::convert_time_column_dd_mm_dd_yyyy_hh(const string& column_name, const char& separator, const bool& header)
{
...
template <class T>
void Matrix<T>::convert_time_column_yyyy_mm(const string& column_name, const char& separator, const bool& header)
{
    // data format -> 1985-4
    const size_t column_index = get_column_index(column_name);
    vector<string> date_elements;
...
template <class T>
void Matrix<T>::convert_time_column_dd_mm_yyyy(const string& column_name, const char& separator, const bool& header)
{
    ...
    for(size_t i = start; i < rows_number; i++)
    {
        ...
        (*this)(i, column_index) = to_string(mktime(&timeinfo)+ 3600*24);
    }
}
...
template <class T>
void Matrix<T>::convert_time_column_mm_dd_yyyy(const string& column_name, const char& separator, const bool& header)
{
...
{
    const Vector<T> time = arrange_column(time_index);

    remove_column(time_index);
...
//    const Vector<size_t> indices(lags_number-1, 1, rows_number-1);

//    const Vector<T> new_time = time.arrange_subvector(indices);

    const Vector<T> new_time(new_rows_number, 3.1416);

    Matrix<T> new_matrix(new_rows_number, new_columns_number);

    Vector<T> new_row(new_rows_number);

    for(size_t i = 0; i < new_rows_number; i++)
    {
        new_row = arrange_rows(i + 1, i + lags_number + steps_ahead_number);

        new_matrix.set_row(i, new_row);
    }

    new_matrix.insert_column(0, new_time);
...
{
    const Vector<T> time = arrange_column(time_variable_index);

    remove_column(time_variable_index);

    const Vector<size_t> indices(lags_number, 1, rows_number - 1);

    const Vector<T> first_column = time.arrange_subvector(indices);
    ...
    new_matrix.insert_column(0, first_column);
...
Matrix<T> Matrix<T>::calculate_lag_plot_matrix(const size_t& maximum_lags_number, const size_t& column_index)
{
    ...
    matrix.remove_column(column_index);
    ...
    for(size_t i = 0; i < new_rows_number; i++)
    {
        row = matrix.arrange_row(i);

        for(size_t j = 1; j <= maximum_lags_number; j++)
        {
            row = row.assemble(matrix.arrange_row(i+j));
        }
...
double Matrix<T>::calculate_multiple_linear_correlation(const Vector<T>& other) const
{
    ...
    {
        return this->arrange_column(0).calculate_linear_correlation(other);
    }
...
KMeansResults<T> Matrix<T>::calculate_k_means(const size_t& k) const
{
    ...
    previous_means.set_row(0, arrange_row(initial_center));
...
#pragma omp parallel for
        ...
        for(int j = 0; j < rows_number; j++)
        {
            ...
            const Vector<T> row_data = arrange_row(j);

            for(size_t l = 0; l < i; l++)
            {
                distances[l] = row_data.calculate_distance(previous_means.arrange_row(l));
            }
        ...
        if(random_failures <= 5)
        {
            previous_means.set_row(i, arrange_row(sample_index));
        }
    }
...
#pragma omp parallel for
        ...
        for(int i = 0; i < rows_number; i++)
        {
            ...
            {
                distances[j] = arrange_row(i).calculate_distance(previous_means.arrange_row(j));
            }
...
template <class T>
void Matrix<T>::load_strings(const string& file_name, const char& delim)
{
    ifstream file(file_name.c_str());
    ...
    if(!file.is_open())
    {
       ...
       buffer << "OpenNN Exception: Matrix template.\n"
              << "void load_strings(const string&,const char&) method.\n"
              << "Cannot open matrix data file: " << file_name << "\n";
...
template <class T>
void Matrix<T>::save_csv(const string& file_name, const char& separator, const Vector<string>& column_names,  const Vector<string>& row_names, const string& nameID) const
{
   ofstream file(file_name.c_str());
...
string Matrix<T>::matrix_to_string(const char& separator) const
{
   ...
   if(rows_number > 0 && columns_number > 0)
   {
       buffer << arrange_row(0).vector_to_string(separator);

       for(size_t i = 1; i < rows_number; i++)
       {
           buffer << "\n"
                  << arrange_row(i).vector_to_string(separator);
       }
   }
...
template <class T>
Matrix<size_t> Matrix<T>::to_size_t_matrix(void) const
{
...
template <class T>
Matrix<double> Matrix<T>::to_double_matrix(void) const
{
...
template <class T>
Matrix<double> Matrix<T>::string_to_double(void) const
{
   Matrix<double> new_matrix(rows_number, columns_number);
...
template <class T>
Matrix<size_t> Matrix<T>::string_to_size_t(void) const
{
...
template <class T>
SparseMatrix<T> Matrix<T>::to_sparse_matrix(void) const
{
...
template <class T>
vector<T> Matrix<T>::to_std_vector(void) const
{
...
Vector<T> Matrix<T>::rows_to_vector(const char& separator) const
{
    ...
    for(size_t i = 0; i < rows_number; i++)
    {
        vector[i] = (*this).arrange_row(i).vector_to_string(separator);
    }
...
template <class T>
Vector< Vector<T> > Matrix<T>::to_vector_of_vectors(void) const
{
    Vector< Vector<T> > vector_of_vectors(columns_number);

    for(size_t i = 0; i < columns_number; i++)
    {
        vector_of_vectors[i] = this->arrange_column(i);
    }
...
void Matrix<T>::print_preview(void) const
{
    cout << "Rows number: " << rows_number << endl
       ...
       if(rows_number > 3)
       {
          const Vector<T> row = arrange_row(rows_number-2);
