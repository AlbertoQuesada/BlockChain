...
string LossIndex::write_error_type(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: LossIndex class.\n"
             << "string write_error_type(void) const method.\n"
             << "Unknown error type.\n";
...
// string write_regularization_type(void) const method

/// Returns a string with the type of regularization term used in the loss functional expression.

string LossIndex::write_regularization_type(void) const
{
...
string LossIndex::write_error_type_text(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: LossIndex class.\n"
             << "string write_error_type_text(void) const method.\n"
             << "Unknown error type.\n";
...
// string write_regularization_type_text(void) const method

/// Returns a string in text format with the type of regularization term used in the loss functional expression.

string LossIndex::write_regularization_type_text(void) const
{
   if(regularization_type == NO_REGULARIZATION)
   {
   ...
   switch(error_type)
   {
      ...
      {                
           ...
           for( const tinyxml2::XMLNode* nodeFor=sum_squared_error_element->FirstChild(); nodeFor; nodeFor=nodeFor->NextSibling() ) {
               ...
               objective_element->InsertEndChild( copy );
           }
...
void LossIndex::from_XML(const tinyxml2::XMLDocument& document)
{
   ...
   {
       const string new_error_type = objective_element->Attribute("Type");
       ...
       switch(error_type)
       {
          ...
          case SUM_SQUARED_ERROR:
          {
               ...
               for( const tinyxml2::XMLNode* nodeFor=objective_element->FirstChild(); nodeFor; nodeFor=nodeFor->NextSibling() ) {
...
// string object_to_string(void) method

/// Writes to a string the members of the loss functional object in text format.

string LossIndex::object_to_string(void) const
{
    ostringstream buffer;
