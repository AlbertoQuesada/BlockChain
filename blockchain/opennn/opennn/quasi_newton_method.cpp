...
// string write_inverse_Hessian_approximation_method(void) const method

/// Returns the name of the method for the approximation of the inverse Hessian. 

string QuasiNewtonMethod::write_inverse_Hessian_approximation_method(void) const
{
...
// const bool& get_apply_early_stopping(void) const method

/// Returns true if the selection loss decrease stopping criteria has to be taken in account, false otherwise.

const bool& QuasiNewtonMethod::get_apply_early_stopping(void) const
{
...
string QuasiNewtonMethod::QuasiNewtonMethodResults::object_to_string(void) const
{
   ostringstream buffer;
...
Matrix<string> QuasiNewtonMethod::QuasiNewtonMethodResults::write_final_results(const size_t& precision) const
{
   ostringstream buffer;
...
string QuasiNewtonMethod::write_training_algorithm_type(void) const
{
...
string QuasiNewtonMethod::object_to_string(void) const
{
    ostringstream buffer;
...
Matrix<string> QuasiNewtonMethod::to_string_matrix(void) const
{
    ostringstream buffer;
