...
const bool& LevenbergMarquardtAlgorithm::get_apply_early_stopping(void) const
{
...
string LevenbergMarquardtAlgorithm::LevenbergMarquardtAlgorithmResults::object_to_string(void) const
{
   ostringstream buffer;
...
string LevenbergMarquardtAlgorithm::write_training_algorithm_type(void) const
{
...
Matrix<string> LevenbergMarquardtAlgorithm::to_string_matrix(void) const
{
    ostringstream buffer;
