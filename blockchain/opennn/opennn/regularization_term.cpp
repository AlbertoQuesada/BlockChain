...
string RegularizationTerm::write_error_term_type(void) const
{
...
string RegularizationTerm::write_information(void) const
{
   return("");
}
...
string RegularizationTerm::object_to_string(void) const
{
   ostringstream buffer;
