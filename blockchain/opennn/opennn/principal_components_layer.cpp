...
// string write_principal_components_method(void) const method

/// Returns a string with the name of the method used for principal components layer.

string PrincipalComponentsLayer::write_principal_components_method(void) const
{
...
// string write_principal_components_method_text(void) const method

/// Returns a string with the name of the method used for principal components layer,
/// as paragaph text.

string PrincipalComponentsLayer::write_principal_components_method_text(void) const
{
    if(principal_components_method == NoPrincipalComponents)
    {
