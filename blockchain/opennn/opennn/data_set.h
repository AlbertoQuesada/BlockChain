...
public:
   ...
   Matrix<double> arrange_used_data(void) const;
   ...
   Vector<double> arrange_testing_time_column(void) const;
   ...
   Vector<string> unuse_constant_variables(void);
   ...
   Vector< Vector< Vector<double> > > calculate_means_columns(void) const;

   // Correlation methods

   Matrix<double> calculate_input_target_correlations(void) const;

   // Information methods


   void print_missing_values_information(void) const;

   void print_input_target_correlations(void) const;

   void print_top_input_target_correlations(const size_t& = 10) const;


   Matrix<double> calculate_variables_correlations(void) const;
   void print_variables_correlations(void) const;
   ...
   void remove_input_data_mean(void);
   ...
   Vector<size_t> filter_variable(const std::string&, const double&, const double&);

   // Data scaling

   Vector<string> calculate_default_scaling_methods(void) const;
...
*/
   ...
   Vector< Statistics<double> > scale_targets_logarithmic(void);
   ...
   Matrix< Vector<double> > calculate_cross_correlation(const size_t& = 10) const;
   Matrix<double> calculate_lag_plot(void) const;
   Matrix<double> calculate_lag_plot(const size_t&);

   // Trending methods

   Vector< LinearRegressionParameters<double> > perform_trends_transformation(void);

   Vector< LinearRegressionParameters<double> > perform_inputs_trends_transformation(void);

   Vector< LinearRegressionParameters<double> > perform_outputs_trends_transformation(void);
   ...
   void impute_missing_values_unuse(void);
   void impute_missing_values_mean(void);
   void impute_missing_values_time_series_mean(void);
   void impute_missing_values_time_series_regression(void);
   void impute_missing_values_median(void);
...
private:
   ...
   Vector<string> read_header_line(void) const;

   void read_instance(const string&, const Vector< Vector<string> >&, const size_t&);

   Vector< Vector<string> > set_from_data_file(void);
