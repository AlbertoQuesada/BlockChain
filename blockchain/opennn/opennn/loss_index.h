...
public:
   ...
   string write_regularization_type(void) const;

   string write_error_type_text(void) const;
   string write_regularization_type_text(void) const;
   ...
   virtual string object_to_string(void) const;
   virtual void save(const string&) const;   
   virtual void load(const string&);   

   virtual string write_information(void);   
