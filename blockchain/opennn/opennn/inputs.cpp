...
Vector<string> Inputs::arrange_names(void) const
{
    const size_t inputs_number = get_inputs_number();
...
Vector<string> Inputs::arrange_units(void) const
{
    const size_t inputs_number = get_inputs_number();
...
Vector<string> Inputs::arrange_descriptions(void) const
{
    const size_t inputs_number = get_inputs_number();
...
Matrix<string> Inputs::arrange_information(void) const
{
    const size_t inputs_number = get_inputs_number();
...
// Vector<string> write_default_names(void) const method
...
Vector<string> Inputs::write_default_names(void) const
{
    const size_t inputs_number = get_inputs_number();
...
string Inputs::object_to_string(void) const
{
    ostringstream buffer;
