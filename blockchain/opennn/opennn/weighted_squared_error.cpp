...
double WeightedSquaredError::get_normalization_coefficient(void) const
{
...
void WeightedSquaredError::set_normalization_coefficient(void)
{
    // Control sentence
...
string WeightedSquaredError::write_error_term_type(void) const
{
...
/*
string WeightedSquaredError::write_information(void) const
{
    ostringstream buffer;
...
string WeightedSquaredError::object_to_string(void) const
{
    ostringstream buffer;
