...
public:
   ...
   explicit InputsTrendingLayer(void);
   ...
   virtual ~InputsTrendingLayer(void);
   ...
   size_t get_inputs_trending_neurons_number(void) const;

   const InputsTrendingMethod& get_inputs_trending_method(void) const;

   string write_inputs_trending_method(void) const;
   ...
   Vector< LinearRegressionParameters<double> > get_inputs_trends(void) const;
   ...
   Vector<double> calculate_outputs(const Vector<double>&, double = 0.0) const;
