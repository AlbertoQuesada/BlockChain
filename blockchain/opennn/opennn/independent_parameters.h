...
public:
   ...
   const Vector<string>& get_names(void) const;
   const string& get_name(const size_t&) const;

   const Vector<string>& get_units(void) const;
   const string& get_unit(const size_t&) const;

   const Vector<string>& get_descriptions(void) const;
   ...
   string write_scaling_method(void) const;
   ...
   string write_bounding_method(void) const;
   ...
   Vector< Vector<string> > arrange_information(void);     
