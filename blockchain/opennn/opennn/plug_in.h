...
public:
   ...
   string write_input_method(void) const;
    
   const string& get_template_file_name(void) const;
   const string& get_input_file_name(void) const;

   const string& get_script_file_name(void) const;

   const string& get_output_file_name(void) const;

   const Vector<string>& get_input_flags(void) const;
