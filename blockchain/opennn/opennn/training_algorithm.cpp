...
const string& TrainingAlgorithm::get_neural_network_file_name(void) const
{
...
string TrainingAlgorithm::write_training_algorithm_type(void) const
{
...
string TrainingAlgorithm::object_to_string(void) const
{
   ostringstream buffer;
...
Matrix<string> TrainingAlgorithm::to_string_matrix(void) const
{
...
string TrainingAlgorithm::TrainingAlgorithmResults::write_stopping_condition(void) const
{
