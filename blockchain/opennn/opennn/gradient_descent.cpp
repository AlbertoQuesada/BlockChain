...
const bool& GradientDescent::get_apply_early_stopping(void) const
{
...
// string GradientDescentResults::object_to_string(void) const method

string GradientDescent::GradientDescentResults::object_to_string(void) const
{
   ostringstream buffer;
...
string GradientDescent::write_training_algorithm_type(void) const
{
...
Matrix<string> GradientDescent::to_string_matrix(void) const
{
    ostringstream buffer;
