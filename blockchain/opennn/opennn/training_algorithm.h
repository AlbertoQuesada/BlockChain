...
public:
   ...
   struct TrainingAlgorithmResults
   {
       ...
       string write_stopping_condition(void) const;
   ...
   const string& get_neural_network_file_name(void) const;
   ...
   virtual string write_training_algorithm_type(void) const;
   ...
   virtual Matrix<string> to_string_matrix(void) const;
