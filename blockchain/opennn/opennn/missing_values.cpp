...
// string write_scrubbing_method(void) const method

/// Returns a string with the name of the method used for scrubbing.

string MissingValues::write_scrubbing_method(void) const
{
...
// string write_scrubbing_method_text(void) const method

/// Returns a string with the name of the method used for scrubbing, as paragaph text.

string MissingValues::write_scrubbing_method_text(void) const
{
    if(scrubbing_method == Unuse)
    {
        return("unuse");
...
Vector<size_t> MissingValues::arrange_missing_indices(const size_t& variable_index) const
{
    ...
    return(missing_indices.arrange_equal_to_indices(1));
}
...
string MissingValues::object_to_string(void) const
{
    ostringstream buffer;
