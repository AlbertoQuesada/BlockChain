...
string OrderSelectionAlgorithm::write_loss_calculation_method(void) const
{
...
string OrderSelectionAlgorithm::OrderSelectionResults::write_stopping_condition(void) const
{
...
string OrderSelectionAlgorithm::OrderSelectionResults::object_to_string(void) const
{
   ostringstream buffer;
