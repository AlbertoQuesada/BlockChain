...
WeightedSquaredRegressionError::WeightedSquaredRegressionError(void) : ErrorTerm()
{
    set_default();
}
...
WeightedSquaredRegressionError::~WeightedSquaredRegressionError(void)
{
}
...
// double get_normalization_coefficient(void) const method

/// Returns the normalization coefficient.

double WeightedSquaredRegressionError::get_normalization_coefficient(void) const
{
...
void WeightedSquaredRegressionError::check(void) const
{
...
void WeightedSquaredRegressionError::set_default(void)
{
...
void WeightedSquaredRegressionError::set_weights(void)
{
    // Control sentence
...
// void set_normalization_coefficient(void) method

/// Calculates of the normalization coefficient with the data of the data set.

void WeightedSquaredRegressionError::set_normalization_coefficient(void)
{
    // Control sentence
...
double WeightedSquaredRegressionError::calculate_error(void) const
{
    // Control sentence
...
double WeightedSquaredRegressionError::calculate_selection_error(void) const
{
    // Control sentence (if debug)
...
ErrorTerm::FirstOrderPerformance WeightedSquaredRegressionError::calculate_first_order_loss(void) const
{
    // Control sentence
...
ErrorTerm::SecondOrderPerformance WeightedSquaredRegressionError::calculate_second_order_loss(void) const
{
    // Control sentence
...
Vector<double> WeightedSquaredRegressionError::calculate_terms(void) const
{
    // Control sentence
...
Matrix<double> WeightedSquaredRegressionError::calculate_terms_Jacobian(void) const
{
    // Control sentence
...
WeightedSquaredRegressionError::FirstOrderTerms WeightedSquaredRegressionError::calculate_first_order_terms(void) const
{
    // Control sentence (if debug)
...
// string write_error_term_type(void) const method

/// Returns a string with the name of the weighted squared error loss type, "WEIGHTED_SQUARED_ERROR".

string WeightedSquaredRegressionError::write_error_term_type(void) const
{
...
tinyxml2::XMLDocument* WeightedSquaredRegressionError::to_XML(void) const
{
    ostringstream buffer;
...
// string write_information(void) const method
/*
string WeightedSquaredRegressionError::write_information(void) const
{
    ostringstream buffer;
...
// string print_weights(void) const method

string WeightedSquaredRegressionError::object_to_string(void) const
{
    ostringstream buffer;
