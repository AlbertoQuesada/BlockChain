...
double NormalizedSquaredError::get_normalization_coefficient(void) const
{
...
void NormalizedSquaredError::set_normalization_coefficient(void)
{
...
void NormalizedSquaredError::set_default(void)
{
...
string NormalizedSquaredError::write_error_term_type(void) const
{
...
/*
string NormalizedSquaredError::write_information(void) const
{
    ostringstream buffer;
