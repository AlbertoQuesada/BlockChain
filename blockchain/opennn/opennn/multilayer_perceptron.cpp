...
// Vector<string> write_layers_activation_function(void) const method

/// Returns a vector of strings with the name of the activation functions for the layers. 
/// The size of this vector is the number of layers. 

Vector<string> MultilayerPerceptron::write_layers_activation_function(void) const
{
    const size_t layers_number = get_layers_number();
...
string MultilayerPerceptron::object_to_string(void) const
{
    ostringstream buffer;
...
// Matrix<string> write_information(void) const method
...
Matrix<string> MultilayerPerceptron::write_information(void) const
{
    ostringstream buffer;
