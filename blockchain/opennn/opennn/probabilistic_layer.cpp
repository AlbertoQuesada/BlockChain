...
// string write_probabilistic_method(void) const method

/// Returns a string with the probabilistic method for the outputs
/// ("Competitive", "Softmax" or "NoProbabilistic").

string ProbabilisticLayer::write_probabilistic_method(void) const
{
...
// string write_probabilistic_method_text(void) const method
...
string ProbabilisticLayer::write_probabilistic_method_text(void) const
{
    if(probabilistic_method == Binary)
    {
        return("binary");
...
string ProbabilisticLayer::object_to_string(void) const
{
    ostringstream buffer;
