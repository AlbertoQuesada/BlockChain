    ...
    for(size_t i = 0; i < layer_1_perceptrons_number; i++)
    {
        for(size_t j = 0; j < layer_2_perceptrons_number; j++)
        {
            if(index_2 == multilayer_perceptron_pointer->get_layers_number()-1)
            {
                ...
                {
                    cout << "Layers delta 02: " << layers_delta << endl;

//                    cout << "--------" << endl;

//                    cout << "Index 1: " << index_1 << endl;
//                    cout << "Index 2: " << index_2 << endl;

//                    cout << "Previous interlayers delta: " << previous_interlayers_Delta(0,0) << endl;

//                    cout << "Interlayers Delta(1,2): " <<
...
//                    cout << "Layers activation derivative: " << layers_activation_derivative[1][j] << endl;
//                    cout << "Synaptic eights index 2: " << multilayer_perceptron_pointer->get_layer(index_2).arrange_synaptic_weights()(0,0) << endl;
//                    cout << "Synaptic eights index 1+1: " << multilayer_perceptron_pointer->get_layer(index_1+1).arrange_synaptic_weights()(0,0) << endl;
//                    cout << "Layer 1 activation derivative: " << layer_1_activation_derivative[i] << endl;
//                    cout << "Layer 1 activation second derivative: " << layer_1_activation_second_derivative[i] << endl;
//                    cout << "Interlayers combination combination Jacobian: " << interlayers_combination_combination_Jacobian(0,0) << endl;
//                    cout << "Actual layers delta: " << multilayer_perceptron_pointer->get_layer(index_1).arrange_synaptic_weights().arrange_column(j).dot(layers_delta) << endl;
...
string ErrorTerm::write_error_term_type(void) const
{
...
string ErrorTerm::write_information(void) const
{
   return("");
}
...
string ErrorTerm::object_to_string(void) const
{
   ostringstream buffer;
