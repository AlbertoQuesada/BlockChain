...
// string write_unscaling_method(void) const method
...
string UnscalingLayer::write_unscaling_method(void) const
{
...
// string write_unscaling_method_text(void) const method

/// Returns a string with the name of the method used for unscaling,
/// as paragraph text.

string UnscalingLayer::write_unscaling_method_text(void) const
{
    if(unscaling_method == NoUnscaling)
    {
        return("no unscaling");
...
string UnscalingLayer::object_to_string(void) const
{
    ostringstream buffer;
