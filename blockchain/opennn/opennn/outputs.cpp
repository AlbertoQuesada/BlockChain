...
Vector<string> Outputs::arrange_names(void) const
{
    const size_t outputs_number = get_outputs_number();
...
Vector<string> Outputs::arrange_descriptions(void) const
{
    return(descriptions);
}
...
Vector<string> Outputs::arrange_units(void) const
{
    const size_t outputs_number = get_outputs_number();
...
Matrix<string> Outputs::arrange_information(void) const
{
    const size_t outputs_number = get_outputs_number();
...
// Vector<string> write_default_outputs_name(void) const method
...
Vector<string> Outputs::write_default_names(void) const
{
    const size_t outputs_number = get_outputs_number();
...
string Outputs::object_to_string(void) const
{
    ostringstream buffer;
