...
public:  
   ...
   Vector< Matrix<double> > calculate_forecasting_target_output_data(void) const;
   ...
   void print_error_data_statistics(void) const;

   Vector< Vector< Statistics<double> > > calculate_forecasting_error_data_statistics(void) const;
   Vector< Matrix<double> > calculate_error_data_statistics_matrices(void) const;
   Vector< Matrix<double> > calculate_forecasting_error_data_statistics_matrices(void) const;
   ...
   Matrix<double> calculate_errors(void) const;
   Matrix<double> calculate_binary_classification_errors(void) const;
   Matrix<double> calculate_multiple_classification_errors(void) const;
   ...
   Vector<double> calculate_forecasting_testing_errors(void) const;
   ...
   Vector< LinearRegressionParameters<double> > calculate_forecasting_linear_regression_parameters(void) const;

   void print_linear_regression_correlations(void) const;

   LinearRegressionResults perform_linear_regression_analysis(void) const;
   LinearRegressionResults perform_forecasting_linear_regression_analysis(void) const;
   ...
   Vector< Vector<double> > calculate_forecasting_time_series(void) const;
