...
// string write_training_rate_method(void) const method

/// Returns a string with the name of the training rate method to be used.

string TrainingRateAlgorithm::write_training_rate_method(void) const
{
   switch(training_rate_method)
   {
      ...
      default:
      {
         ...
         buffer << "OpenNN Exception: TrainingRateAlgorithm class.\n"
                << "string get_training_rate_method(void) const method.\n"
