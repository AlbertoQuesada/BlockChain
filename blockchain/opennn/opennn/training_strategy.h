...
public:
   ...
   string write_initialization_type(void) const;
   string write_main_type(void) const;
   string write_refinement_type(void) const;

   string write_initialization_type_text(void) const;
   string write_main_type_text(void) const;
   string write_refinement_type_text(void) const;
