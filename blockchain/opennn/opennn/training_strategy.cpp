...
// string TrainingStrategy::write_initialization_type(void) const
...
string TrainingStrategy::write_initialization_type(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: TrainingStrategy class.\n"
             << "string write_initialization_type(void) const method.\n"
...
// string TrainingStrategy::write_main_type(void) const
...
string TrainingStrategy::write_main_type(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: TrainingStrategy class.\n"
             << "string write_main_type(void) const method.\n"
             << "Unknown main type.\n";
...
// string TrainingStrategy::write_refinement_type(void) const
...
string TrainingStrategy::write_refinement_type(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: TrainingStrategy class.\n"
             << "string write_refinement_type(void) const method.\n"
...
// string TrainingStrategy::write_initialization_type_text(void) const
...
string TrainingStrategy::write_initialization_type_text(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: TrainingStrategy class.\n"
             << "string write_initialization_type_text(void) const method.\n"
             << "Unknown training algorithm type.\n";
...
// string TrainingStrategy::write_main_type_text(void) const
...
string TrainingStrategy::write_main_type_text(void) const
{
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: TrainingStrategy class.\n"
             << "string write_main_type_text(void) const method.\n"
             << "Unknown main type.\n";
...
string TrainingStrategy::write_refinement_type_text(void) const
{
   if(refinement_type == NO_REFINEMENT)
   {
      return("none");
   ...
   else
   {
      ...
      buffer << "OpenNN Exception: TrainingStrategy class.\n"
             << "string write_refinement_type_text(void) const method.\n"
             << "Unknown refinement type.\n";
...
string TrainingStrategy::object_to_string(void) const
{
   ostringstream buffer;
