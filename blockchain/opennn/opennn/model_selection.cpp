...
Vector<NeuralNetwork> ModelSelection::perform_k_fold_cross_validation(const size_t& k)
{
    ...
    for(size_t i = 0; i < k; i++)
    {
        ...
        if(display)
        {
            std::cout << "Iteration: " << i << "/" << k << std::endl;
    ...
    if(display)
    {
        std::cout << "Cross validation error: " << cross_validation_error/k << std::endl;
    }
...
Vector<NeuralNetwork> ModelSelection::perform_positives_cross_validation()
{
    ...
    const Vector<size_t> positives_instances_indices = data_set_pointer->get_variable(target_index).arrange_greater_than_indices(0.5);
    ...
    for(size_t i = 0; i < positives_instances_number; i++)
    {
        ...
        const Vector<double> current_inputs_selection_instance = current_selection_instance.arrange_subvector(inputs_indices);
        ...
        double current_error = std::abs(target_data-output_data);
        ...
        if(display)
        {
            std::cout << "Iteration: " << i+1 << "/" << positives_instances_number << std::endl;
            std::cout << "instance index: " << current_selection_instance_index << std::endl;
    ...
    if(display)
    {
        std::cout << "Cross validation error: " << cross_validation_error/positives_instances_number << std::endl;
    }
