...
public:
   ...
   InputsTrendingLayer* get_inputs_trending_layer_pointer(void) const;
   ...
   OutputsTrendingLayer* get_outputs_trending_layer_pointer(void) const;
...
//   void set(const IndependentParameters&);
   ...
   void destruct_inputs_trending_layer(void);
   void destruct_scaling_layer(void);
   void destruct_unscaling_layer(void);
   void destruct_outputs_trending_layer(void);
   ...
   string write_expression(void) const;
   string write_expression_python(void) const;
   string write_expression_R(void) const;
