...
string ThresholdSelectionAlgorithm::ThresholdSelectionResults::write_stopping_condition(void) const
{
...
string ThresholdSelectionAlgorithm::ThresholdSelectionResults::object_to_string(void) const
{
   ostringstream buffer;
