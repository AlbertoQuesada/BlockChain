...
public:
   ...
   explicit WeightedSquaredRegressionError(void);
   ...
   virtual ~WeightedSquaredRegressionError(void);
   ...
   double get_normalization_coefficient(void) const;
   ...
   void set_normalization_coefficient(void);
   ...
   string write_error_term_type(void) const;
...
//   string write_information(void) const;
