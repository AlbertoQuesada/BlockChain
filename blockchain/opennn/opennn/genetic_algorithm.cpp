...
// string write_initialization_method(void) const method

/// Return a string with the initialization method of genetic algorithm.

string GeneticAlgorithm::write_initialization_method(void) const
{
...
// string write_crossover_method(void) const method

/// Return a string with the crossover method of genetic algorithm.

string GeneticAlgorithm::write_crossover_method(void) const
{
...
// string write_fitness_assignment_method(void) const method

/// Return a string with the fitness assignment method of genetic algorithm.

string GeneticAlgorithm::write_fitness_assignment_method(void) const
{
...
void GeneticAlgorithm::set_default(void)
{
    ...
    else
    {
        ...
        maximum_iterations_number = (size_t)max(100.,inputs_number*5.);
...
GeneticAlgorithm::GeneticAlgorithmResults* GeneticAlgorithm::perform_inputs_selection(void)
{
    ...
    optimal_inputs.set(original_uses.count_equal_to(Variables::Input),0);
    ...
    while(!end)
    {
        ...
        if(display)
        {
            ...
            cout << "Generation optimal inputs: " << variables->arrange_inputs_name().vector_to_string() << " " << endl;
            ...
            cout << "Generation selection mean = " << loss.arrange_column(1).calculate_mean() << endl;
            cout << "Generation selection standard deviation = " << loss.arrange_column(1).calculate_standard_deviation() << endl;
...
// Matrix<string> to_string_matrix(void) const method

/// Writes as matrix of strings the most representative atributes.

Matrix<string> GeneticAlgorithm::to_string_matrix(void) const
{
    ostringstream buffer;
...
string GeneticAlgorithm::GeneticAlgorithmResults::object_to_string(void) const
{
    ostringstream buffer;
