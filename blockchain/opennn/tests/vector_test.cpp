...
void VectorTest::test_impute_time_series_missing_values_mean(void)
{
...
void VectorTest::test_calculate_quartiles(void)
{
...
void VectorTest::test_insert_element(void)
{
...
void VectorTest::test_split_element(void)
{
...
void VectorTest::test_difference(void)
{
...
void VectorTest::test_intersection(void)
{
...
void VectorTest::test_arrange_unique(void)
{
    message += "test_unique\n";
