...
InputsTrendingLayerTest::InputsTrendingLayerTest(void) : UnitTesting()
{
}

// DESTRUCTOR

InputsTrendingLayerTest::~InputsTrendingLayerTest(void)
{
}

// METHODS

void InputsTrendingLayerTest::test_constructor(void)
{
...
void InputsTrendingLayerTest::test_destructor(void)
{
   message += "test_destructor\n";
}


void InputsTrendingLayerTest::run_test_case(void)
{
